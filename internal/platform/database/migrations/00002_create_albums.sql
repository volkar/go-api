...
CREATE INDEX idx_albums_main_pagination ON albums (user_id, date_at DESC, id DESC) WHERE deleted_at IS NULL;
CREATE INDEX idx_albums_trashed_pagination ON albums (user_id, deleted_at DESC, id DESC) WHERE deleted_at IS NOT NULL;
